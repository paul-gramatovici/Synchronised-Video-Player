package Server;/* ------------------
   Server.Server
   usage: java Server.Server [RTSP listening port]
   ---------------------- */
...
public class Server extends JFrame implements ActionListener {
    ...
    static int FRAME_PERIOD = 33; //Frame period of the video to stream, in ms
    ...
    static int state; //RTSP Server.Server state == INIT or READY or PLAY
    ...
    public static void main(String argv[]) throws Exception
    {
        ...
        while(!done) {
            ...
            if (request_type == SETUP) {
                ...
                //init the Server.VideoStream object:
